...
**Breif**: Design a class called Stopwatch. The job of this class is to simulate a stopwatch. It should
...
#### My Assumption
I made the assumption this was a simple interface that could be used to time internal functions similar to timing functions or blocks of code.