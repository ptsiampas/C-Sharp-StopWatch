    ...
    class StopWatch
    {
        ...
        public string ElapsedTime
        {
            get
            {
                ...
                foreach (var timeDiff in _durations)
                {
                    et += timeDiff;

                }
                return et.ToString("h'h 'm'm 's's'");
            }
        }
        ...
        public void Start()
        {
            if (_isRunning)
            {
                throw new InvalidOperationException("Trying to start the Stop watch twice.");
            }
        ...
        public void Stop()
        {
            _durations.Add(this.StartTime - DateTime.Now);
            _isRunning = false;
        }
    }
}
